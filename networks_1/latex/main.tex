...
\begin{enumerate}[label={(2. \alph*)}]
    \item
        ...
        \end{figure}
    \item
        I simulated 10000 random walkers and plotted the resulting position distribution for 1000, 2000 and 3000 samples, overlayed with the gaussian profile \[
            p(x;t) = \frac{1}{\sqrt{2 \pi D t}} \exp{\frac{-x^2}{4 D t} 
        .\] With D given by,
        \[
            D = \frac{\langle x^2 \rangle}{2}
        .\] The distribution given in the sheet has mean=0
\end{enumerate}
